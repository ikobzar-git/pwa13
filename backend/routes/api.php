...
Route::post('/auth/staff/send-code', [AuthController::class, 'staffSendCode']);
Route::post('/auth/staff/verify', [AuthController::class, 'staffVerify']);
Route::post('/auth/client/send-code', [AuthController::class, 'clientSendCode']);
Route::post('/auth/client/verify', [AuthController::class, 'clientVerify']);
